package com.calemi.sledgehammers.client;
...
public class SledgehammerRenderTypes extends RenderType {
    ...
    public SledgehammerRenderTypes(String name, VertexFormat format, VertexFormat.Mode mode, int bufferSize, boolean affectsCrumbling, boolean sortOnUpload, Runnable setupState, Runnable clearState) {
